...
// Render renders file attachment chips followed by skill chips. When not
// in deleting mode and showRemove is true, each file chip shows an icon,
// filename, and a remove button (✕) on the right. showRemove should be
// false for attachments on already-posted messages, where removal is not
// possible.
