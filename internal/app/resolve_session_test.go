...
func (m *mockSessionService) UpdateTitleAndUsage(context.Context, string, string, bool, int64, int64, float64) error {
	return nil
}

func (m *mockSessionService) Rename(context.Context, string, string, bool) error {
	return nil
}
